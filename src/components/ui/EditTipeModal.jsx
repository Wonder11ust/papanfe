...
const EditTipeModal = ({ isOpen, onClose, onSave, product }) => {
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="Masukkan tipe hunian"
                />
              </div>
            </div>
